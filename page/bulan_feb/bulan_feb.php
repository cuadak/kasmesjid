...
<head>
  ...
  <title>Kas Bulan Februari</title>
  ...
  <div id="wrapper">
      ...
      <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseKas" aria-expanded="true" aria-controls="collapseKas">
        ...
        <div id="collapseKas" class="collapse show" aria-labelledby="headingKas" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="../bulan_feb/bulan_feb.php">Februari</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <span><a target="_blank" href="../ekspor/bulan_feb_pdfbutton.php" class="btn btn-dark"><i class="fas fa-file-pdf"></i> Ekspor PDF</a></span>
          </div>
          <div style="height:10px;"></div>
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Kas Bulan Februari</h6>
            </div>
            <div class="card-body">
              ...
              <div class="table-responsive">
                <table id="example" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php 
                    ...
                    $data = mysqli_query($koneksi,"select * from feb");
                  ...
                  <a href="#edit<?php echo $d['id']; ?>" data-toggle="modal" class="btn btn-warning"><i class="fas fa-edit"></i> Edit</a> || 
							    ...
							    <?php include('bulan_feb_editdeletemodal.php'); ?>
                  </tr>
                 <?php 
                 }
                 ?>
                ...
                $res1 = $pdo->prepare('SELECT SUM(masuk) AS totMasuk FROM feb');
                $res1->execute();
                ...
                <?php 
                //$pdo = new PDO('mysql:host=localhost;dbname=kasmesjid', 'root', '');
                $res1 = $pdo->prepare('SELECT SUM(keluar) AS totKeluar FROM feb');
                $res1->execute();
                $row = $res1->fetch(PDO::FETCH_ASSOC);
          ...
          <?php include('bulan_feb_tambahmodal.php'); ?>
        </div>
        <!-- /.container-fluid -->
  ...
  <div class="modal fade" id="kosongkanModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button class="btn btn-secondary" type="button" data-dismiss="modal">Batal</button>
          <a class="btn btn-danger" href="../kosongtabel/bulan_feb_empty.php">Kosongkan</a>
        </div>
      </div>
    </div>
  </div>
