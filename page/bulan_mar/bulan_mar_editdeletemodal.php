    ...
    <div class="modal fade" id="del<?php echo $d['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<?php
					$del=mysqli_query($koneksi,"select * from mar where id='".$d['id']."'");
                ...
                <div class="modal-footer">
                    ...
                    <a href="bulan_mar_delete.php?id=<?php echo $d['id']; ?>" class="btn btn-danger"><span class="fas fa-trash"></span> Hapus</a>
                </div>
    ...
    <div class="modal fade" id="edit<?php echo $d['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
				<?php
					$edit=mysqli_query($koneksi,"select * from mar where id='".$d['id']."'");
					$erow=mysqli_fetch_array($edit);
				?>
				<div class="container-fluid">
				<form method="POST" action="bulan_mar_edit.php?id=<?php echo $erow['id']; ?>">
					<div class="row">
						<div class="col-lg-2">
